...
public class Grafic extends JFrame {
	...
	/*
	 * fonction qui affiche un background animé en cas de la selection facile
	 */
	...
	/*
	 * fonction qui affiche un background animé en cas de la selection difficile
	 */
	...
	public Grafic() {
		...
		txtrFacile.setFont(new Font("MV Boli", Font.PLAIN, 17));

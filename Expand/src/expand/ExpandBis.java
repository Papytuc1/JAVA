...
public class ExpandBis {
	...
	public static void main(String[] args) {
		...
		/* pour chaque ligne de tableauMultiple elle associe une valeur � multiple pour la premier it�ration
		...
		for (ListIterator<Integer> iter = tableauMultiple.listIterator(); iter.hasNext(); ) {
			...
			if (iter.hasNext()) {
				System.out.print("*");
				/*  on utilise un nouvel objet : l'iterateur qu'on construit � partir de
				 * tableau multiple, l'iterateur permet de parcourir une liste est poss�de les m�thode haseNext, hasPrevious
				 * et regarder la doc

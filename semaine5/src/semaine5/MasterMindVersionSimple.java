...
public class MasterMindVersionSimple {
	/**
	...
	public static void main(String[] args) {
		...
		String[] tableauFacilitateur = new String[4];
		String saisie="";
		int countEssai = 12;
		boolean verif = false;
		int count1 =0;
		...
		while(!verif && countEssai > 0) {		
			...
			for (int i = 0 ; i<tableauUtilisateurCopie.length; i++) {
				for (int k = 0; k < tableauCouleurRandomCopie.length; k++) {
					...
					else if(!tableauUtilisateurCopie[i].equals(tableauCouleurRandomCopie[k]) && !tableauUtilisateurCopie[k].equals("-")) {
						tableauFacilitateurCopie[i]= "0";
					}
				}					  
			}
